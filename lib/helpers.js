...
(function() {
  var _, ansi, crypto, date_format, descend, log, logDate, moment, static_exts, util,
  ...
  exports.is_static_url = function(url) {
    var ref;
    return ref = url.split('.').slice(-1)[0], indexOf.call(static_exts, ref) >= 0;
  };
  ...
  exports.hashobj = function(o) {
    return exports.md5(JSON.stringify(o));
  };
