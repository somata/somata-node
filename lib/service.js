...
(function() {
  var Binding, CHECK_INTERVAL, ConsulAgent, EventEmitter, SomataService, VERBOSE, descend, helpers, log, os, util, _,
  ...
  module.exports = SomataService = (function(_super) {
    ...
    SomataService.prototype.handleUnsubscribe = function(client_id, message) {
      var subscription_id, subscription_key, type;
      type = message.type;
      subscription_id = message.id;
      subscription_key = [client_id, subscription_id].join(':');
      log.w("Unsubscribing <" + subscription_key + ">");
      return this.subscriptions[type] = _.without(this.subscriptions[type], subscription_key);
    };
