  ...
  module.exports = SomataService = (function(_super) {
    ...
    SomataService.prototype.register = function(cb) {
      ...
      return this.consul_agent.registerService(service_description, (function(_this) {
        return function(err, registered) {
          ...
          log.s("Registered service `" + _this.name + "` on :" + _this.rpc_binding.port);
          if (cb != null) {
    ...
    SomataService.prototype.registerExternally = function(cb) {
      ...
      return this.consul_agent.registerExternalService(service_description, (function(_this) {
        return function(err, registered) {
          log.s("Registered external service `" + _this.name + "` on " + _this.rpc_binding.host + ":" + _this.rpc_binding.port);
          if (cb != null) {
            return cb(null, registered);
          }
        };
    ...
    SomataService.prototype.deregister = function(cb) {
      ...
      return this.consul_agent.deregisterService(this.id, (function(_this) {
        return function(err, deregistered) {
          log.e("[deregister] Deregistered `" + _this.name + "` from :" + _this.rpc_binding.port);
          if (cb != null) {
    ...
    SomataService.prototype.deregisterExternally = function(cb) {
      ...
      return this.consul_agent.deregisterExternalService(service_description, (function(_this) {
        return function(err, deregistered) {
          log.e("[deregisterExternally] Deregistered `" + _this.name + "` from " + _this.rpc_binding.host + ":" + _this.rpc_binding.port);
          if (cb != null) {
            return cb(null, deregistered);
          }
        };
