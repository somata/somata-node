...
(function() {
  var Binding, CHECK_INTERVAL, CHECK_TTL, ConsulAgent, EXTERNAL, EventEmitter, PREFIX, SERVICE_HOST, SomataService, VERBOSE, _, descend, emitters, helpers, log, os, util,
  ...
  module.exports = SomataService = (function(superClass) {
    ...
    SomataService.prototype.handleUnsubscribe = function(client_id, message) {
      var ref, subscription_id, subscription_key, subscription_keys, type;
      type = message.type;
      subscription_id = message.id;
      subscription_key = [client_id, subscription_id].join('::');
      log.w("Unsubscribing <" + subscription_key + ">");
      ref = this.subscriptions_by_type;
      for (type in ref) {
        subscription_keys = ref[type];
    ...
    SomataService.prototype.serviceTags = function() {
      var tags;
      tags = [];
      tags.push("proto:" + this.rpc_binding.proto);
      if (this.rpc_binding.proto !== 'tcp') {
        tags.push("host:" + this.rpc_binding.host);
      }
      return tags;
    };
