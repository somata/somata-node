...
(function() {
  ...
  module.exports = SomataService = (function(superClass) {
    ...
    function SomataService(name, methods, options) {
      ...
      (base = this.rpc_options).proto || (base.proto = SERVICE_PROTO);
      (base1 = this.rpc_options).host || (base1.host = SERVICE_HOST);
      (base2 = this.rpc_options).port || (base2.port = SERVICE_PORT);
    ...
    SomataService.prototype.deregister = function(cb) {
      if (this.registry_connection.timed_out) {
        ...
        this.registry_connection.sendMethod(null, 'deregisterService', [this.name, this.id], (function(_this) {
