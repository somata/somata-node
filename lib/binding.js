...
(function() {
  var BargeBinding, DEFAULT_BIND, DEFAULT_PORT, DEFAULT_PROTO, EventEmitter, VERBOSE, log, randomString, util, zmq, _ref,
  ...
  module.exports = BargeBinding = (function(_super) {
    __extends(BargeBinding, _super);
