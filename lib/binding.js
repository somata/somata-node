...
(function() {
  var Binding, DEFAULT_HOST, DEFAULT_PROTO, EventEmitter, VERBOSE, log, makeAddress, randomPort, randomString, ref, util, zmq,
  ...
  ref = require('./helpers'), makeAddress = ref.makeAddress, randomPort = ref.randomPort, randomString = ref.randomString, log = ref.log;
