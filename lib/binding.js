  ...
  module.exports = Binding = (function(superClass) {
    ...
    Binding.prototype.tryBind = function(n_retried) {
      ...
      try {
        ...
        if (VERBOSE) {
          log.d("[tryBind] Attempting to bind on " + this.address + "...");
        }
        ...
        err = error;
        log.e("[tryBind] Failed to bind on " + this.address, err);
    ...
    Binding.prototype.handlePing = function(client_id, message) {
      var pong;
      if (message.ping === 'hello' || this.known_pings[client_id] !== message.id) {
        this.known_pings[client_id] = message.id;
    ...
    Binding.prototype.handleMethod = function(client_id, message) {
      ...
      if (VERBOSE) {
        log.d("[Binding.on method]", message);
      }
