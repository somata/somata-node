...
module.exports = Client = class Client {
  ...
  onWsMessage(message_json) {
    var _, error, event, id, message, pending_error, pending_request, pending_subscription, response;
    ...
    if (response) {
      ...
      if ([_, pending_error] = this.ws_requests[id]) {
        return pending_error(message.error);
      } else {
