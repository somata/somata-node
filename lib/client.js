...
(function() {
  var CONNECTION_KEEPALIVE_MS, CONNECTION_LINGER_MS, CONNECTION_RETRY_MS, Client, Connection, ConsulAgent, EventEmitter, KEEPALIVE, PREFIX, VERBOSE, helpers, log, randomString, util, _,
    __slice = [].slice;
