...
(function() {
  var CONNECTION_KEEPALIVE_MS, CONNECTION_LINGER_MS, CONNECTION_RETRY_MS, Client, Connection, EventEmitter, KEEPALIVE, REGISTRY_HOST, REGISTRY_PORT, REGISTRY_PROTO, VERBOSE, _, emitters, helpers, log, randomString, util,
    slice = [].slice;
