...
module.exports = Client = class Client {
  ...
  wsRequest(method, ...args) {
    var id;
    id = uuid();
    this.sendWsMessage({id, method, args});
    return new Promise((resolve, reject) => {
      return this.ws_requests[id] = resolve;
    });
  }
  ...
  wsSubscribe(event, ...args) {
    var id, subscription;
    id = uuid();
    this.sendWsMessage({id, event, args});
  ...
  onWsMessage(message_json) {
    var event, id, message, pending_request, pending_subscription, response;
