...
(function() {
  var CONNECTION_KEEPALIVE_MS, CONNECTION_LINGER_MS, CONNECTION_RETRY_MS, Client, Connection, ConsulAgent, EventEmitter, KEEPALIVE, PREFIX, VERBOSE, emitters, helpers, log, randomString, util, _,
    __slice = [].slice;
  ...
  Client.prototype.subscribe = function() {
    var args, cb, me, service_name, subscription_id, type, _i, _trySubscribe;
