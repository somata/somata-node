...
(function() {
  ...
  Client.prototype.remote = function() {
    ...
    this.getServiceConnection(service_name, function(err, service_connection) {
      if (err) {
        return log.e(err);
      } else {
  ...
  Client.prototype.getServiceConnection = function(service_name, cb) {
    ...
    if (this.save_connections && (service_connection = this.service_connections[service_name])) {
