...
(function() {
  var ConsulAgent, DEFAULT_BASE_URL, EventEmitter, HEALTH_POLL_MS, VERBOSE, async, healthyInstances, log, request, unhealthyInstances, util, _,
  ...
  ConsulAgent.prototype.setDefaults = function() {
    var _base;
    (_base = this.options).base_url || (_base.base_url = DEFAULT_BASE_URL);
  ...
  ConsulAgent.prototype.deregisterExternalService = function(service, cb) {
    return this.apiRequest('PUT', '/catalog/deregister/' + service_id, service, cb);
  };
