...
(function() {
  ...
  ConsulAgent.prototype.checkServiceHealth = function(service_name, index, cb) {
    if (index == null) {
      index = null;
    }
    if (index === null) {
